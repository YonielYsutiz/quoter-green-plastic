...
<body>
    ...
    <table class="document-table">
        ...
        <tr>
            ...
            <th width="15%">TOT UND</th>
            <th width="15%">PESO</th>
        </tr>
        <tr>
            <td>Listones Superiores</td>
            <td>0</td>
            <td>0</td>
            <td>0</td>
            <td>0</td>
    ...
    <table class="document-table">
        <tr>
            ...
            <td width="20%"><span class="checkbox"></span> Crédito</td>
            <td width="20%"><span class="checkbox"></span> Plazo de días</td>
            <td width="30%"><span class="checkbox"></span> Contado</td>
        </tr>
        <tr>
