...
<body>
    ...
    <table>
        <tr>
            ...
            <th style="width: 17.5%;">FAB</th>
            <th style="width: 17.5%;">DESC</th>
            <th style="width: 17.5%;">SERV</th>
            <td style="width: 17.5%; border: none;"></td>
        </tr>
        <tr>
            <td style="text-align: left; border: none;">Tipo de orden:</td>
            <td>0</td>
            <td>0</td>
            <td>0</td>
    ...
    <table>
        <tr>
            <th colspan="3">Descargue productos stock distribucion - comercializacion</th>
        </tr>
        <tr>
