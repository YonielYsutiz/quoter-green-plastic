...
<body>
    <table>
        ...
        <tr>
            <th>
                <h1 style="text-align: center;">OT</h1>
            </th>
            <td>fecha orden</td>
            <td>12/12/24</td>
        </tr>
        <tr>
            ...
            <td style="padding-right: 40px;">12/12/24</td>
            <th style="text-align: center;">0</th>
        </tr>
        <tr>
            <td></td>
            <td>Fecha compromiso entrega</td>
            <td>12/12/24</td>
        </tr>
        <tr>
            <td></td>
            <td>Comercial a cargo</td>
            <th style="border: 1px solid #ddd; text-align: center;">0</th>
        </tr>
        </tr>
    ...
    <tr>
        ...
        <h2>PRODUCTO POR FAVOR LAS ESTIBAS DEBEN IR MARCADAS CON LOGO GREEN PLASTIC</h2>
        <table>
            <tr>
                <td style="width: 200px;"><strong>Cantidad a Fabricar</strong></td>
                <th style="text-align: center; width: 200px;">0</th>
            </tr>
            <table>
                <tr>
                    <th>Como se debe Fabricar</th>
                </tr>
                <tr>
                    <td></td>
                    <td style="border: 1px solid #ddd;">CANT</td>
                    <td style="border: 1px solid #ddd;">TIPO</td>
                    <td style="border: 1px solid #ddd;">LARGO</td>
                    <td style="border: 1px solid #ddd;">TONT UND</td>
                </tr>
                <tr>
            ...
            <!-- <div class="highlight">Diátecica entre Dormientes</div> -->
            <table>
                <tr>
                    <td class="highlight" style="border: 1px solid #ddd;">Descripción</td>
                ...
                <tr>
                    <th>Como se fabrico - Tamaños y Consumo (Diligencia produccion)</th>
                </tr>
                <tr>
                    <td>01/04/2025</td>
                    <td>0</td>
            ...
            <table>
                <tr>
                    <th>Descargue productos stock distribucion - comercializacion</th>
                </tr>
                <tr>
                    <td style="border: 1px solid #ddd;">Cantidad</td>
                    <td style="border: 1px solid #ddd;">Producto</td>
                    <td style="border: 1px solid #ddd;">Peso</td>
                </tr>
                <tr>
                ...
                <th><strong>STOCK GPC</strong></th>
            </table>

            <table>
                <tr>
                    <td style="border: 1px solid #ddd;">Dilatacion entre Durmientes </td>
