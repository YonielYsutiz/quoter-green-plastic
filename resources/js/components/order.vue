    ...
    <el-col :span="9">
      <el-card shadow="always" class="box-card">
        <div slot="header" class="clearfix">
          <span style="font-size: 1.5em;">Informacion general de la orden</span>
        </div>
        <div>
          <el-row>
            <el-col>
              ...
              <el-checkbox-group v-model="form.tipoOrden">
                <el-checkbox label="Fabricación" />
                <el-checkbox label="Descargue Inv" />
                <el-checkbox label="Servicio Post Venta" />
              </el-checkbox-group>
            </el-col>
          </el-row>
        ...
        <div>
          <el-row :gutter="12">
            ...
            <el-col :span="12" style="border-right-color: #efefef; border-right-style: solid" >
              ...
              <el-row>
                <el-col :span="12">
                  <el-checkbox v-model="form.transport_in_invoice" label="1">Facturar transporte con IVA</el-checkbox>
                </el-col>
                <el-col :span="12">
                  <el-checkbox v-model="form.transport_in_invoice" label="1">OT sin valor de transporte para cliente</el-checkbox>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="12">
                  <el-checkbox v-model="form.transport_in_invoice" label="1">Incluir valor de transporte en factura</el-checkbox>
                </el-col>
                <el-col :span="12">
              ...
              <el-row>
                <el-col :span="12">
                  <el-checkbox v-model="form.transport_in_invoice" label="1">Transporte incluido en el precio</el-checkbox>
                </el-col>
                <el-col :span="12">
